...
var ConfigDropper = createReactClass({
  displayName: 'ConfigDropper',
  ...
  getInitialState: function() {
    ...
    var state = {
      ...
      banner: this.props.post.banner,
      origin: this.props.post.origin
    };
  ...
  componentWillReceiveProps: function(nextProps) {
    ...
    var state = {
      ...
      banner: nextProps.post.banner,
      origin: nextProps.post.origin
    };
  ...
  _globalMouseDown: function(e) {
    var mine = ReactDOM.findDOMNode(this);
    var node = e.target;
    while (node) {
  ...
  _onChangeBanner: function(e) {
    this.setState({
      banner: e.target.value
    });
  },

  _onChangeOrigin: function(e) {
    this.setState({
  ...
  save: function() {
    ...
    var banner = this.props.post.banner;
    var origin = this.props.post.origin;
    var textDate = date.toISOString();
    var isSameMetadata = isMetadataEqual(
      this.state,
      tagCatMeta.metadata,
      this.props.post
    );
    if (
      textDate === this.props.post.date &&
  ...
  config: function() {
    return (
      <div className="config">
        ...
        <div className="config_section">
          <div className="config_section-title">Banner</div>
          <input
            className="config_author"
            value={this.state.banner}
            onChange={this._onChangeBanner}
          />
        </div>
        <div className="config_section">
          <div className="config_section-title">Origin link</div>
          <input
            className="config_author"
  ...
  render: function() {
    return (
      <div
        ...
        title="Settings"
      >
        <div className="config-dropper_handle" onClick={this._toggleShow}>
